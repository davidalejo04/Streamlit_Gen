...
fig1 = px.area(df_daily, x="fechahora", y="valor", color="tipogeneracion", template="plotly_dark",labels={"fechahora": "Mes-Año", "valor": "Generación [MW/H]", "tipogeneracion": "Tipo de generación"})
